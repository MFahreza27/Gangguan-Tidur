                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title">DATA GEJALA</h4><hr>
                            <a href="{{ route('admin.gejala.create') }}" class="btn btn-primary rounded-0">Tambahkan Data</a>
                        </div> <hr>
                            ...
                            <table class="table table-bordered" id="clientside">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="w-60 text-wrap text-justify">Deskripsi</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.gejala.edit',['id' => $d->id]) }}" class="btn btn-primary btn-sm mdi mdi-lead-pencil"> Edit</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('admin.gejala.delete',['id'=>$d->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
